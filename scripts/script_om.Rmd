...
df_OM_merged$Zone <- dplyr::recode(df_OM_merged$Zone,
  "PZ" = "Pioneer zone",
  "LM" = "Low marsh",
  "HM" = "High marsh"
)
df_OM_merged$Zone <- factor(df_OM_merged$Zone, levels = c("Pioneer zone", "Low marsh", "High marsh"))
```

# Step 2: Plots
## Step 2a: Point plots
```{r}
Plot_OM_yearly <- df_OM_merged %>% 

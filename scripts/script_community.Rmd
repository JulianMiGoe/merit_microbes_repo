...
## Step 7f: Plot dissimilarities & elevation + statistics
```{r}
...
plot_bray_delta_combined <- ggarrange(
  ...
  ncol = 2, 
  nrow = 2,
  labels = c("A", "B", "C", "D"), # Add custom labels
  font.label = list(size = 14, face = "bold"), # Customize label appearance
  common.legend = TRUE, # Optional: shared legend

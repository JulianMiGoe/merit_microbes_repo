...
#ord_explore(ps_rare)
layer.labs <- c(
  "Top-soil\n(0-30 cm)" = "Top-soil (0-30 cm)",
  "Bottom-soil\n(40-100 cm)" = "Bottom-soil (40-100 cm)"
)
...
plot_all_treatment_layer_nmds <- ps_rare %>%
 ...
 facet_grid(Layer ~ Zone,   labeller = labeller(Layer = layer.labs)) +  # Layers as rows (vertical), Zones as columns (horizontal)
  theme_JM
...
# S1: PERMANOVA Ai  tchinson distance
```{r}
